...
class ComercialRegiaoAPIView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        Body esperado:
        {
            ...
            "incluir_condominios": false,  // Opcional
        ...
        incluir_condominios = request.data.get('incluir_condominios', False)
        ...
        try:
            ...
            business_types = ["real_estate_agency"]
            keyword = None
            
            if incluir_condominios:
                # Para condomínios, usamos keyword pois não há tipo específico
                keyword = "condomínio"
            ...
            response_data = {
                ...
                "estabelecimentos": resultados['places'],
                "total_encontrado": len(resultados['places'])
            }
            
            logger.info(f"Busca concluída: {len(resultados['places'])} estabelecimentos encontrados")
